...
#   sku_name            = "P1v2"       # Choose a pricing tier that fits your needs
# }
...
#     application_stack {
#       docker_image     = "${azurerm_container_registry.acr.login_server}/${var.docker_image_name}:${var.docker_image_tag}"
